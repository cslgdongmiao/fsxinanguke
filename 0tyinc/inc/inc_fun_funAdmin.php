...
function SpGetEditor($fname,$fvalue,$nheight="350",$etype="Basic",$gtype="print",$isfullpage="false",$bbcode=false)
{
    ...
    if($GLOBALS['cfg_html_editor']=='fck')
    {
        ...
        $fck->BasePath        = $GLOBALS['cfg_cmspath'].'/0tyinc/FCKeditor/' ;
        $fck->Width        = '100%' ;
        $fck->Height        = $nheight ;
    ...
    else if($GLOBALS['cfg_html_editor']=='ckeditor')
    {
        ...
        $CKEditor->basePath = $GLOBALS['cfg_cmspath'].'/0tyinc/ckeditor/' ;
        $config = $events = array();
	  ...
	  else if($GLOBALS['cfg_html_editor']=='Ueditor')
    {
        ...
        $UEditor = new UEditor();
        $UEditor->basePath = $GLOBALS['cfg_cmspath'].'/0tyinc/ueditor/';
        ...
        $ded->BasePath        = $GLOBALS['cfg_cmspath'].'/0tyinc/htmledit/' ;
        $ded->Width        = '100%' ;
        $ded->Height        = $nheight ;

...
define('DEDEDATA', DEDEROOT.'/0tydt');
...
//站点根目录
$cfg_basedir = preg_replace('#'.$cfg_cmspath.'\/0tyinc$#i', '', DEDEINC);
if($cfg_multi_site == 'Y')
{
...
$cfg_plus_dir = $cfg_cmspath.'/0typl';
$cfg_phpurl = $cfg_mainsite.$cfg_plus_dir;

$cfg_data_dir = $cfg_cmspath.'/0tydt';
...
$cfg_softname = '天佑网站内容管理系统';
$cfg_soft_enname = 'TYCMS';
$cfg_soft_devteam = '天佑企划';

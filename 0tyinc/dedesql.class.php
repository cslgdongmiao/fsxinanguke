...
EOT;
    ...
    {
        $errorTrackFile = dirname(__FILE__).'/../0tydt/mysql_error_trace.inc';
        if( file_exists(dirname(__FILE__).'/../0tydt/mysql_error_trace.php') )
        {
            @unlink(dirname(__FILE__).'/../0tydt/mysql_error_trace.php');
        }
        $emsg = '';

...
class yeepay
{
    ...
    var $return_url='/0typl/carbuyaction.php?dopost=return'; //返回处理地址
    ...
    */
    function GetCode($order, $payment)
    {
        ...
        //$p8_Url                        = $cfg_basehost."/0typl/carbuyaction.php?dopost=return&code=".$payment['code'];  
    ...
    */
    ...
    function  log_result($word) {
        global $cfg_cmspath;
        $fp = fopen(dirname(__FILE__)."/../../0tydt/payment/log.txt","a");
        flock($fp, LOCK_EX) ;

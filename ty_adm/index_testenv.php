...
// 检测权限
$safeMsg = array();
if(TestExecuteable(DEDEROOT.'/0tydt',$cfg_basehost) || TestExecuteable(DEDEROOT.'/uploads',$cfg_basehost))
{
...
if(PostHost($cfg_basehost.'/0tydt/admin/ver.txt') === @file_get_contents(DEDEDATA.'/admin/ver.txt'))
{

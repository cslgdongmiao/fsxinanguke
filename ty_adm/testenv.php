...
<script type="text/javascript" src="../0tyinc/js/jquery/jquery.js" ></script>
</head>
...
if(!function_exists('PostHost'))
{
	...
	$cfg_cmspath/0tydt|
	$cfg_cmspath/0tydt/$cfg_backup_dir|
	$cfg_cmspath/0tydt/textdata|
	$cfg_cmspath/0tydt/sessions|
	$cfg_cmspath/0tydt/tplcache|
	$cfg_cmspath/0tydt/admin|
	$cfg_cmspath/0tydt/enums|
	$cfg_cmspath/0tydt/mark|
	$cfg_cmspath/0tydt/module|
	$cfg_cmspath/0tydt/rss|
	$cfg_special|

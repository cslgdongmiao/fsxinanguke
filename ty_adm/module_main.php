...
require_once(dirname(__FILE__)."/../0tyinc/dedemodule.class.php");
require_once(dirname(__FILE__)."/../0tyinc/oxwindow.class.php");
...
else if($action=='setup')
{
    ...
    $prvdir .= "<tr style='background:#e3ecf9'><th width='270'>目录</td><th align='center'>可写</td></tr>\r\n";
  ...
  <tr>
    <td height='30' class='dtb' bgcolor='#e4eef9' colspan='2'>
    <b>注意事项：</b>
